...
Public Class rptvcomplaints
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "main.rptvcomplaints.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrptvcomplaints
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptvcomplaints = New rptvcomplaints
        rpt.Site = Me.Site
        Return rpt
    End Function
