...
+---------------------*/
 ...
 |
 */
 $config['FAL_website_name']    = "AlphaNet Professional Education";
 ...
 |
 */
 $config['FAL_user_support'] = 'Administrator@AlphaNet.org';
...
+-------------------*/
 ...
 // REGISTRATION
  ...
  $config['FAL_user_first_name_field_validation_register'] = 'trim|required|xss_clean';
  $config['FAL_user_last_name_field_validation_register'] = 'trim|required|xss_clean';
  $config['FAL_user_address_field_validation_register'] = 'trim|required|xss_clean';
  $config['FAL_user_city_field_validation_register'] = 'trim|required|xss_clean';
  $config['FAL_user_zip_field_validation_register'] = 'trim|required|xss_clean';
  $config['FAL_user_phone_field_validation_register'] = 'trim|required|xss_clean';
  $config['FAL_user_agency_field_validation_register'] = 'required|xss_clean|agency_check';
 ...
 */
 ...
 // ERROR DELIMITERS
  ...
  $config['FAL_error_delimiter_open'] = '<li>';
  
  //closing tag for the validation error messages
  $config['FAL_error_delimiter_close'] = '</li>';
...
+-------------------*/
 ...
 $config['FAL_login_success_action'] = 'dashboard';
...
$config['FAL_admin_login_success_action'] = 'dashboard';
