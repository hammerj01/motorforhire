...
class Freakauth_light
{
    ...
    */
    ...
    function getRegistrationForm()
    {
		...
		$values['first_name'] = $this->CI->input->post('first_name');
		$values['last_name'] = $this->CI->input->post('last_name');
		$values['address'] = $this->CI->input->post('address');
		$values['city'] = $this->CI->input->post('city');
		$values['state'] = $this->CI->input->post('state');
		$values['zip'] = $this->CI->input->post('zip');
		$values['phone'] = $this->CI->input->post('phone');
		$values['agency'] = $this->CI->input->post('agency');
		$values['agency_affiliation'] = $this->CI->input->post('agency_affiliation');
		$values['agency_address'] = $this->CI->input->post('agency_address');
		$values['agency_city'] = $this->CI->input->post('agency_city');
		$values['agency_state'] = $this->CI->input->post('agency_state');
		$values['agency_zip'] = $this->CI->input->post('agency_zip');
		$values['agency_phone'] = $this->CI->input->post('agency_phone');
		$values['agency_license_state'] = $this->CI->input->post('agency_license_state');
		$values['agency_state_number'] = $this->CI->input->post('agency_state_number');
		$values['more_agencies'] = $this->CI->input->post('more_agencies');
		$values['terms_conditions'] = $this->CI->input->post('terms_conditions');
