...
{	
    ...
    function Admins()
    {
        ...
        $this->_container = $this->config->item('FAL_template_dir').'template_admin/users_container';
    ...
    function index()
    {
		$this->heading = 'Manage Admins';
			
		//let's paginate results
		$this->load->library('pagination');
		
		$config['base_url'] = base_url().$this->config->item('index_page').'/'.'dashboard/admins';
    ...
    {      
		...
		{	 
			...
			//redirect to list
			redirect('dashboard/admins', 'location');
		}
