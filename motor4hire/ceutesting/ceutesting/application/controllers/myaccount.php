...
class Myaccount extends Controller 
{
	...
	function edit()
	{
		...
		if (belongsToGroup('superadmin') OR belongsToGroup('user') AND $id === $this->db_session->userdata('id'))
		{
			...
			$rules['email'] = 'trim|required|valid_email|xss_clean|callback__email_backend_duplicate_check';
		...
		{			
			...
			//redirect to list
			redirect('dashboard/profile/'.$id, 'location');
		}
	}
