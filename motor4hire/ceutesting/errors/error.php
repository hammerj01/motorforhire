...
<!-- Begining of error code routine -->
...
$top_table = '
    ...
    "border-collapse: collapse" width="80%" id="table1"
...
$bot_table = '<br><br><center><hr noshade color="red" width="100%"></center><font face=arial size=2><b>Technical Details</b><br> Error Number: '. 
$error . '
